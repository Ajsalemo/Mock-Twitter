...
// ----------------------------------------------------------------------------------------------------- //
// **These two functions toggle 'dark/night mode' styling
// **This function changes the main background color of the page
export const changeGridBackground = modeChange => {
    if (modeChange) return '#000000e0';
};

// **This function changes the background of the selected component 
export const changeComponentBackground = modeChange => {
    if (modeChange) return '#000000d6';
}

// *This function changes the border color of the selected component
export const changeBorder = modeChange => {
    if (modeChange) return '1px solid #0a71b0';
}

// **This function changes the font color of the component
export const fontColorChange = (modeChange) => {
    if (modeChange) return '#fff';
};
